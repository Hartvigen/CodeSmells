...
VARIANTS=('dead-local-store' 'duplicate-code' 'feature-envy' 'parameter-by-value' 'repeated-conditionals' 'self-assignment' 'short-circuit'
           ...
           'dead-local-store duplicate-code feature-envy parameter-by-value repeated-conditionals self-assignment short-circuit type-checking dead-code redundant-data-storage in-line')
